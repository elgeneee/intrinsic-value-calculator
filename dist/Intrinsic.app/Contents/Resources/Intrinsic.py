...
ticker_ENTRY.place(x=145, y=8, width = 100)
...
operating_cash_flow_ENTRY.place(x=145, y=48, width = 150)
...
total_debt_ENTRY.place(x=145 , y= 128, width = 150)
...
cash_and_short_term_investment_ENTRY.place(x=525 , y= 8, width = 150)
...
no_of_shares_outstanding_ENTRY.place(x=525 , y= 128, width = 150)
...
intrinsic_value_per_share.place(x=400, y=280)

error_message = Label(root, text = '', fg= 'red')
error_message.place(x = 400, y = 310)
...
##button##
calc_button = Button(root, text = 'Calculate',command = calc, width = 30, height = 2,cursor = 'pointinghand')
calc_button.place(x = 400, y = 330)

add_button = Button(root, text = 'Add Entry',command = add_entry, width = 30, height = 2,cursor = 'pointinghand')
add_button.place(x = 400, y = 370)

delete_button = Button(root,text = 'Delete Entry', command = delete_entry, width = 30, height = 2,cursor = 'pointinghand')
delete_button.place(x = 400, y = 410)

view_all_button = Button(root, text = 'View All',command = view_all, width = 30, height = 2,cursor = 'pointinghand')
view_all_button.place(x = 400, y = 450)

clear_button = Button(root, text = 'Clear', command = clear, width = 30, height = 2,cursor = 'pointinghand')
clear_button.place(x = 400, y = 490)
